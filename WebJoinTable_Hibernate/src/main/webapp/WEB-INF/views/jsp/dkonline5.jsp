		...
		<header class="header d-flex flex-row">
			<div class="header_content d-flex flex-row align-items-center">
				...
				<div class="logo_container">
					<div class="logo">
						<img src="resources/images/logo.png" alt=""> <span>KHÓA
							HỌC</span>
				...
				<nav class="main_nav_container">
					<div class="main_nav">
						<ul class="main_nav_list">
							...
							<li class="main_nav_item"><a href="courses.html">khóa
									học</a></li>
							<li class="main_nav_item"><a href="elements.html">lịch
									khai giảng</a></li>
		...
		<div class="popular page_section">
			<div class="container">
				...
				<div class="row course_boxes">
					...
					<div class="col-lg-4 course_box" style="color: black;">Hỗ trợ
					...
					<div class="footer_content">
						<div class="row">
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="logo_container">
									<div class="logo">
										<img src="resources/images/logo.png" alt=""> <span>course</span>
									</div>
								</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_column_content">
									<ul>
										...
										<li class="footer_list_item"><a href="#">Campus
												Pictures</a></li>
									...
									<ul>
										<li class="footer_contact_item">
											<div class="footer_contact_icon">
												<img src="resources/images/placeholder.svg"
													alt="https://www.flaticon.com/authors/lucy-g">
											</div> Blvd Libertad, 34 m05200 Arévalo
										</li>
										<li class="footer_contact_item">
											<div class="footer_contact_icon">
												<img src="resources/images/smartphone.svg"
													alt="https://www.flaticon.com/authors/lucy-g">
											</div> 0034 37483 2445 322
										</li>
										<li class="footer_contact_item">
											<div class="footer_contact_icon">
												<img src="resources/images/envelope.svg"
													alt="https://www.flaticon.com/authors/lucy-g">
