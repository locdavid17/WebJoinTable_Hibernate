			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div><a class="btn btn-success" href="dkonline">Đăng Kí học</a></div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="resources/images/course_4.jpg" alt="https://unsplash.com/@kellitungay">
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Bắt Đầu với PHP, LARAVEL</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
						...
						<div><a class="btn btn-success" href="dkonline3">Đăng Kí học</a></div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="resources/images/course_5.jpg" alt="https://unsplash.com/@claybanks1989">
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Băt đầu với JAVA..</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
						...
						<div><a class="btn btn-success" href="dkonline4">Đăng Kí học</a></div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						<img class="card-img-top" src="resources/images/course_6.jpg" alt="https://unsplash.com/@element5digital">
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Bắt đầu với .NET</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
						...
						<div><a class="btn btn-success" href="dkonline5">Đăng Kí học</a></div>
					</div>
				</div>
