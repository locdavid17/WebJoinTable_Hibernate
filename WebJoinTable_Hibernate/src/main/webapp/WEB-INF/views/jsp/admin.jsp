                      ...
                      <!-- Page-header end -->
                        <div class="pcoded-inner-content">
                            ...
                            <div>
                                ...
                                <h1>LIST Student</h1>
                                   <a class="btn btn-success" href="initInsertStudent">Add New Student</a>
                                ...
                                <table style="width:100%" border="1" cellspacing="20" cellpadding="10">
                                    ...
                                    <c:forEach items="${list }" var="s">
                                        <tr>
                                            ...
                                            <td ><a class="btn btn-danger" href="deleteStudent?studentId=${s.studentId}" onclick="return confirm('Bạn có muốn xoá không')">Delete</a></td>
                                            <td ><a class="btn btn-primary" href="initUpdateStudent?studentId=${s.studentId}" onclick="return confirm('Bạn có muốn sửa không')">Edit</a></td>
                                        </tr>
                                    </c:forEach>
                                </table>
