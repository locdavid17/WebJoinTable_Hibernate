			...
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
					<li class="main_nav_item"><a href="#">home</a></li>
						...
						<li class="main_nav_item"><a href="elements.html">lịch khai giảng</a></li>
...
<!-- Hero Slider -->
		<div class="hero_slider_container">
			<div class="hero_slider owl-carousel">
				...
				<!-- Hero Slide -->
				<div class="hero_slide">
					<div class="hero_slide_background" style="background-image:url(resourcesimages/slider_background.jpg)"></div>
					<div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
						<div class="hero_slide_content text-center">
							<h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">Get your <span>Education</span> today!</h1>
						</div>
		...
		<div class="hero_boxes_inner">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 hero_box_col">
						<div class="hero_box d-flex flex-row align-items-center justify-content-start">
							<img src="resources/mega/images/professor.svg" class="svg" alt="">
							<div class="hero_box_content">
			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Lập Trình C/C++.....</a></div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Lập Trình LARAVEL,HTML,CSS</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Lập Trình JAVA, JSP SERVLET</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
